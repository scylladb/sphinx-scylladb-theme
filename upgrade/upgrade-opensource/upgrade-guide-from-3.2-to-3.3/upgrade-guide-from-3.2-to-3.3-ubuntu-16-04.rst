...
.. |SRC_VERSION| replace:: 3.2
.. |NEW_VERSION| replace:: 3.3
.. |SCYLLA_NAME| replace:: Scylla
.. |PKG_NAME| replace:: scylla
.. |SCYLLA_REPO| replace:: Scylla deb repo
.. _SCYLLA_REPO: http://www.scylladb.com/download/ubuntu-16-04/
.. |SCYLLA_METRICS| replace:: Scylla Metrics Update - Scylla 3.2 to 3.3
.. _SCYLLA_METRICS: ../metric-update-3.2-to-3.3
.. |SCYLLA_MONITOR| replace:: Scylla Monitoring 3.1
