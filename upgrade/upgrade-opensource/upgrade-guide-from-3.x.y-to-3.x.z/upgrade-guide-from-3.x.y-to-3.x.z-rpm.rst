...
.. include:: _common/note_3.1.0_to_3.1.1.rst
...
1. Update the `Scylla RPM repo <http://www.scylladb.com/download/#fndtn-RPM>`_ to **3.x**
2. install
...
.. _upgrade-3.x.y-to-3.x.z-rpm-rollback-procedure:
