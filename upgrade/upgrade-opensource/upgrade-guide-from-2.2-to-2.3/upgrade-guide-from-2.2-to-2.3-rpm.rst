...
1. Update the `Scylla RPM repo <http://www.scylladb.com/download/centos_rpm/>`_ to **2.3**
2. install
...
2. Update the `Scylla RPM repo <http://www.scylladb.com/download/centos_rpm/>`_ to **2.2**
3. Install
