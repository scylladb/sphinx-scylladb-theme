...
1. Update the `Scylla RPM repo <http://www.scylladb.com/download/centos_rpm/>`_ to **3.0**
2. install
...
2. Update the `Scylla RPM repo <http://www.scylladb.com/download/centos_rpm/>`_ to **2.3**
3. Install
