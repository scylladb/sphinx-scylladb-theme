      ...
      n(113),
        ...
        s(document).ready(function () {
          ...
          s(document).foundation(),
            ...
            (e = s("table.docutils")).wrap("<div class='table-wrapper'></div>"),
            e.each(function () {
              s(this).find("thead tr").length > 1 &&
                (console.log("in"), s(this).addClass("thead-border"));
            }),
            (n = s(".content").find("h2").parent()),
            ...
            (r = (i = s(".promo-banner")).outerHeight()),
            o().get("scylladocs-hide-banner")
              ? i.hide()
              : (i.show(),
                s("body").css("padding-top", r),
                s(".side-nav").css("padding-top", r),
                s(".secondary-side-nav").css("padding-top", r)),
            (function () {
              var t = s(".promo-banner"),
                e = t.outerHeight();
              s(window).resize(function () {
                t.is(":visible") &&
                  (s("body").css("padding-top", e),
                  s(".side-nav").css("padding-top", e),
                  s(".secondary-side-nav").css("padding-top", e));
              });
            })(),
            s(".custom-promo-banner__close").on("click", function () {
              o().set("scylladocs-hide-banner", "1"),
                s("body").css("padding-top", 0),
                s(".sidebar-left").css("padding-top", 0),
                s(".sidebar-right").css("padding-top", 0),
                s(".promo-banner").hide();
            });
        });
    },
