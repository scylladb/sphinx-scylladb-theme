...
cassandra-stress is a tool for benchmarking and load testing a Scylla and Cassandra clusters. cassandra-stress supports testing arbitrary CQL tables and queries to allow users to benchmark their data model.
