...
This command lists the currently installed sctool version for both the client and the server.
...
.. code-block:: none
   ...
   sctool version
   Client version: 1.2.0-0.20180717.cf79dcc
   Server version: 1.2.0-0.20180717.cf79dcc
...
.. code-block:: none
   ...
   ├──────────────────────────────────────┼──────────┼────────────────┼────────────────┤
   │ db7faf98-7cc4-4a08-b707-2bc59d65551e │ cluster  │ 198.100.51.11  │ scylla-manager │
   ╰──────────────────────────────────────┴──────────┴────────────────┴────────────────╯
...
.. code-block:: none
   ...
   sctool repair -c prod-cluster -s 2019-05-02T15:04:05Z07:00 --interval-days 7
...
.. code-block:: none
   ...
   sctool repair -c prod-cluster --dc asia-\* -s 2018-09-15T19:00:05Z07:00 --interval-days 7
...
.. code-block:: none
   ...
   sctool repair -c prod-cluster -K orders.\*2018_12_\* -s 2018-12-04T08:00:05Z07:00 --interval-days 7
...
.. code-block:: none
   ...
   ├──────────────────────────────────────────────┼───────────────────────────────┼──────┼────────────┼────────┤
   │ *repair/afe9a610-e4c7-4d05-860e-5a0ddf14d7aa │ 02 Oct 16 20:21 UTC (+3 days) │ 3    │ dc:[dc1]   │ NEW    │
   │ repair/4d79ee63-7721-4105-8c6a-5b98c65c3e21  │ 03 Oct 18 00:00 UTC (+7 days) │ 3    │            │ NEW    │
   ╰──────────────────────────────────────────────┴───────────────────────────────┴──────┴────────────┴────────╯
...
.. code-block:: none 
   ...
   sctool task update -c prod-cluster repair/143d160f-e53c-4890-a9e7-149561376cfd -s now+3h --interval 2
