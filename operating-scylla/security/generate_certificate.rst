...
* :code:`db.crt` - PEM format certificate
* :code:`db.key` - PEM format key for the above certificate
* :code:`cadb.pem` - PEM format signing identity that can be used as a trust store.
...
* :doc:`Encryption: Encryption: Data in Transit Node to Node </operating-scylla/security/node_node_encryption/>`
