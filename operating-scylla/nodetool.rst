...
.. toctree::
   ...
   nodetool-commands/stop
   nodetool-commands/tablestats
   Nodetool tablehistograms <nodetool-commands/cfhistograms>
...
* **removenode** :code:`<ID>`- Remove node with the provided ID
...
* :doc:`setlogginglevel</operating-scylla/nodetool-commands/setlogginglevel>` - sets the logging level threashold for Scylla classes
* :doc:`settraceprobability </operating-scylla/nodetool-commands/settraceprobability/>` ``<value>`` - Sets the probability for tracing a request. Value is trace probability between 0 and 1.
...
* :doc:`stop </operating-scylla/nodetool-commands/stop/>` - Stop compaction.
