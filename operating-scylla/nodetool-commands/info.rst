...
cluster, such as uptime, load, key cache hit rate, total count of all
...
|           |                              |
+-----------+------------------------------+
| Genera    |Generatio n No - When a major |
| tion No   |change occurs on a node, such |
|           |as a restart or a changing    |
|           |tokens, the Generatio n number|
|           |is increased                  |
|           |                              |
|           |                              |
|           |                              |
...
|           |                              |
+-----------+------------------------------+
| Data      |Which Data Center the node    |
| Center    |locate                        |
|           |                              |
|           |                              |
|           |                              |
...
|           |                              |
+-----------+------------------------------+
| Except    |Not applicabl e with Scylla   |
| ions      |                              |
|           |                              |
|           |                              |
+-----------+------------------------------+
| Key       |Not applicabl e with Scylla   |
| Cache     |                              |
|           |                              |
|           |                              |
+-----------+------------------------------+
...
| Cache     |                              |
+-----------+------------------------------+
| Counte    |Not applicabl e with Scylla   |
| r Cache   |                              |
|           |                              |
|           |                              |
+-----------+------------------------------+
