...
.. note:: using trace or debug logging levels create very large log files where the reader may not find what they are looking for. It is best to use these levels for a very short period of time or with the help of Scylla Support. 
...
order of severity and verbocity:
...
----------------------
:doc:`Change the Log Level</troubleshooting/log_level/>`
