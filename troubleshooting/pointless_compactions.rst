...
Scylla's CPU utilization is unexpectedly high and we see too many compactions while there are no many
...
Scylla SSTables can have expired or to be expired tombstones in it and there is need to clean them up eventually. Those
...
heuristics to force compactions to happen in a lone table that has a certain ratio of expired tombstones.
